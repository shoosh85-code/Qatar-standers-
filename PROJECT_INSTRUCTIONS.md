...
- Word: Professional header + حقول قابلة للتعديل + مراجع QCS clause
...
- أيهما يخدم المستخدم المستهدف أفضل؟
- أيهما أدق حسب QCS 2024؟
- أيهما يحوّل مستخدمين Free → Pro أكثر؟
- أيهما يقلل الأخطاء الهندسية في الموقع؟
- أيهما أسرع تنفيذاً واختباراً؟

---

## ENGINEERING STANDARDS

- اتبع QCS 2024 بدقة — نبّه المستخدم إذا وُجد تعارض
- كل آلة حاسبة: input validation + وحدات قطرية + Pass/Fail + مرجع QCS
- كل تصدير: QatarSpec Pro header + مشروع + مهندس + تاريخ + QCS clause
- كل AI output: عربي + تحذير + QCS Part/Section/Clause بالضبط
