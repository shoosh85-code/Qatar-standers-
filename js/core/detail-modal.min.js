...
setTimeout(function(){
  if(key==='bld_calculator'){
    ...
    // أضف داخل lang-content-ar الموجود لتجنب trigger bilingual observer
    ...
    w.innerHTML='<span style="font-size:26px">\uD83C\uDFD7\uFE0F</span><span style="flex:1"><strong style="color:#E8C97A;font-size:14px;display:block">\u062a\u062d\u0644\u064a\u0644 \u0627\u0644\u0645\u062e\u0637\u0637\u0627\u062a \u0627\u0644\u0647\u0646\u062f\u0633\u064a\u0629<\/strong><span style="color:#B0A898;font-size:11px">\u0627\u0631\u0641\u0639 PDF \u2190 BOQ \u0648\u0641\u0642 QCS 2024<\/span><\/span><span style="color:#C9A84C;font-size:18px">\u2190<\/span>';
