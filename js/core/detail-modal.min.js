...
var _extraHtml = '<div class="qcs-disclaimer" style="background:rgba(231,76,60,0.08);border:1px solid rgba(231,76,60,0.2);border-radius:6px;padding:8px;margin-top:14px;font-size:10px;color:#999;line-height:1.6;">' +
...
_extraHtml += '<a href="/tools.html#blueprint-section" style="display:block;margin-top:12px;background:linear-gradient(135deg,rgba(122,21,21,0.25),rgba(201,168,76,0.08));border:1px solid rgba(201,168,76,0.4);border-radius:12px;padding:14px;text-decoration:none;"><div style="display:flex;align-items:center;gap:12px;"><div style="font-size:28px;">🏗️</div><div style="flex:1;"><div style="font-size:14px;font-weight:800;color:#E8C97A;">\u062a\u062d\u0644\u064a\u0644 \u0627\u0644\u0645\u062e\u0637\u0637\u0627\u062a \u0627\u0644\u0647\u0646\u062f\u0633\u064a\u0629</div><div style="font-size:11px;color:#B0A898;margin-top:2px;">\u0627\u0631\u0641\u0639 PDF \u2190 \u0627\u0633\u062a\u062e\u0631\u0627\u062c \u0627\u0644\u0623\u0628\u0639\u0627\u062f \u2190 BOQ \u0648\u0641\u0642 QCS 2024</div></div><div style="color:#C9A84C;font-size:18px;font-weight:700;">\u2190</div></div></a>';
}
_dmEl.insertAdjacentHTML('beforeend', _extraHtml);
}
...
setTimeout(function(){
  if(key==='bld_calculator'){
    var dmc=document.getElementById('dmContent');
    if(!dmc)return;
    if(dmc.querySelector('[data-bp]'))return;
    var arDiv=dmc.querySelector('.lang-content-ar');
    var target=arDiv||dmc;
    var w=document.createElement('a');
    w.setAttribute('data-bp','1');
    w.href='/tools.html#blueprint-section';
    w.style.cssText='display:flex!important;align-items:center;gap:12px;margin-top:20px;padding:16px;background:linear-gradient(135deg,rgba(122,21,21,0.3),rgba(201,168,76,0.1));border:2px solid rgba(201,168,76,0.5);border-radius:12px;text-decoration:none;';
    w.innerHTML='<span style="font-size:26px">&#127959;</span><span style="flex:1"><strong style="color:#E8C97A;font-size:14px;display:block">&#x062a;&#x062d;&#x0644;&#x064a;&#x0644; &#x0627;&#x0644;&#x0645;&#x062e;&#x0637;&#x0637;&#x0627;&#x062a; &#x0627;&#x0644;&#x0647;&#x0646;&#x062f;&#x0633;&#x064a;&#x0629;</strong><span style="color:#B0A898;font-size:11px">&#x0627;&#x0631;&#x0641;&#x0639; PDF &#x2190; BOQ &#x0648;&#x0641;&#x0642; QCS 2024</span></span><span style="color:#C9A84C;font-size:18px">&#x2190;</span>';
    target.appendChild(w);
    // راقب إذا حُذف وأعده
    var _bpObs=new MutationObserver(function(){
      if(!target.querySelector('[data-bp]')){
        _bpObs.disconnect();
        setTimeout(function(){target.appendChild(w);},50);
      }
    });
    _bpObs.observe(target,{childList:true});
  }
},500);
...
safeTimeout('restoreVideo', _restoreVideosAfterDOMRebuild, 50);
if (typeof setLang === 'function') setLang(currentLang || 'ar');
setTimeout(function(){const k=document.getElementById('detailModal')?.dataset?.currentKey;if(k==='bld_calculator'){const dmc=document.getElementById('dmContent');if(!dmc)return;dmc.querySelector('[data-blueprint-card]')?.remove();const w=document.createElement('div');w.setAttribute('data-blueprint-card','');w.className='lang-content-ar lang-content-en';w.style.cssText='display:block!important;margin-top:24px!important;visibility:visible!important;opacity:1!important;';w.innerHTML='<a href="/tools.html#blueprint-section" style="display:block!important;padding:18px 24px;background:linear-gradient(135deg,rgba(122,21,21,0.3),rgba(201,168,76,0.15));color:#E8C97A!important;border-radius:12px;text-decoration:none;text-align:center;font-weight:700;font-size:1.1rem;border:1px solid rgba(201,168,76,0.5);">🏗️ \u062a\u062d\u0644\u064a\u0644 \u0627\u0644\u0645\u062e\u0637\u0637\u0627\u062a \u0627\u0644\u0647\u0646\u062f\u0633\u064a\u0629</a>';dmc.appendChild(w);}},0);
}
