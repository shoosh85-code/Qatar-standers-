  ...
  async function doSearch() {
    ...
    if (qcsChunks.length > 0) {
      systemPrompt = 'أنت خبير مواصفات هندسية قطرية. لديك نصوص QCS 2024 الرسمية التالية كمرجع:\n\n' +
        qcsContext + '\n\n' +
        'التعليمات:\n' +
        '1. أجب بناءً على النصوص أعلاه فقط — لا تخترع أرقاماً أو مواصفات\n' +
        '2. اذكر رقم القسم والجزء والبند (QCS Section/Part/Clause) لكل معلومة\n' +
        '3. إذا المعلومة غير موجودة في النصوص أعلاه، قل: "غير موجود في المصادر المتاحة"\n' +
        '4. أجب بالعربية مع المصطلحات التقنية بالإنجليزية\n' +
        '5. استخدم جداول HTML عند المقارنة (class="dm-table")\n' +
        '6. اذكر قيم Pass/Fail والحدود الدنيا/القصوى';
    } else {
