...
if (card.getAttribute('data-param') === '/tools.html#blueprint-section') return;
...
if (card.getAttribute('data-param') === '/tools.html#blueprint-section') { card.classList.add('animate-in'); return; }
obs.observe(card);
});
}
if (document.readyState === 'loading') {
