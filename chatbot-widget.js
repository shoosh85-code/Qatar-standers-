...
(function () {
  ...
  async function sendMessage(text) {
    ...
    var _KB = [
      ...
      // ── GENERAL & HELP ────────────────────────────────────
      { k: ['ما هو','what is','عن التطبيق','about','تعريف','وش هذا'], w: 3,
        r: '🏗️ **QatarSpec Pro — ما هو؟**\n\nأكبر مرجع رقمي للمواصفات الهندسية في قطر.\n\n**يشمل:**\n• 111+ قسم مرجعي من QCS 2024 + Ashghal + KAHRAMAA + MMUP\n• 8 حاسبات هندسية Pass/Fail\n• بحث ذكي بالذكاء الاصطناعي\n• نماذج Ashghal رسمية\n• أدوات AI: مفتش ذكي + محلل وثائق + محلل مخططات\n• لوحة مشاريع + تسعير BOQ\n\n🇶🇦 مصمم خصيصاً لمهندسي ومقاولي قطر' },
